...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("[deeptalk] Error:", err);
    return NextResponse.json(
      { error: "Something went wrong", reply: "Sorry, let me try that again. What are you craving? 🍽️" },
      { status: 500 }
    );
  }
}
